...
describe("posterUrl", () => {
  ...
  test("returns URL with default size w342", () => {
    expect(posterUrl("/foo.jpg")).toBe(
      "https://image.tmdb.org/t/p/w342/foo.jpg",
    );
  });

  test("returns URL with explicit size", () => {
    expect(posterUrl("/foo.jpg", "w500")).toBe(
      "https://image.tmdb.org/t/p/w500/foo.jpg",
    );
  });

  test("returns URL with w92 size", () => {
    expect(posterUrl("/bar.jpg", "w92")).toBe(
      "https://image.tmdb.org/t/p/w92/bar.jpg",
    );
  });

  test("returns URL with original size", () => {
    expect(posterUrl("/baz.jpg", "original")).toBe(
      "https://image.tmdb.org/t/p/original/baz.jpg",
    );
  });
});
...
describe("backdropUrl", () => {
  ...
  test("returns URL with explicit size", () => {
    expect(backdropUrl("/backdrop.jpg", "w780")).toBe(
...
describe("profileUrl", () => {
  ...
  test("returns URL with default size w185", () => {
    expect(profileUrl("/profile.jpg")).toBe(
      "https://image.tmdb.org/t/p/w185/profile.jpg",
    );
  });

  test("returns URL with explicit size", () => {
    expect(profileUrl("/profile.jpg", "w45")).toBe(
      "https://image.tmdb.org/t/p/w45/profile.jpg",
    );
  });
});
...
describe("logoUrl", () => {
  ...
  test("returns URL with default size w185", () => {
    expect(logoUrl("/logo.png")).toBe(
      "https://image.tmdb.org/t/p/w185/logo.png",
    );
  });

  test("returns URL with explicit size", () => {
    expect(logoUrl("/logo.png", "w500")).toBe(
